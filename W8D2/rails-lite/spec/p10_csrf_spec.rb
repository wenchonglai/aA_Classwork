...
describe WLControllerBase do
  ...
  describe '#invoke_action' do
    before(:all) do
      class DummyController < WLControllerBase
      ...
      class CatsController < WLControllerBase
        def index
        end
      end
    end
